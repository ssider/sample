...
var foosResource = schema.GroupVersionResource{Group: apps.GroupName, Version: apps.Version, Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: apps.GroupName, Version: apps.Version, Kind: "Foo"}
