...
import (
	...
	appsv1alpha1 "k8s.io/sample/pkg/apis/apps/v1alpha1"
	versioned "k8s.io/sample/pkg/generated/clientset/versioned"
	internalinterfaces "k8s.io/sample/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "k8s.io/sample/pkg/generated/listers/samplecontroller/v1alpha1"
)
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appsv1alpha1.Foo{}, f.defaultInformer)
}
